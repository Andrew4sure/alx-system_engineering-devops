...
15.Write a script that converts a number frWrite a script that prints every other line from the input, starting with the first line.om base 10 to base 16.
